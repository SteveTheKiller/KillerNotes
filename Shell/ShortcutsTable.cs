...
namespace KillerNotes.Shell
{
    ...
    public partial class MainWindow
    {
        ...
        [
            ...
            new("Alt+T", "Str_KS_Template", "Note", [(KbLayer.Alt, "T", "Str_Kb_Template")]),
            new("Alt+Delete", "Str_KS_Trash", "Note", [(KbLayer.Alt, "Del", "Str_Kb_Trash")]),
            new("Alt+B", "Str_KS_BackupNow", "File", [(KbLayer.Alt, "B", "Str_Kb_Backup")]),
