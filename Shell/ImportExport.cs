...
namespace KillerNotes.Shell
{
    ...
    public partial class MainWindow
    {
        ...
        private void NotesList_Drop(object sender, DragEventArgs e)
        {
            ...
            if (HandleGroupDrop(e)) return;      // Groups.cs: reorder / re-nest a group (1.1.0)
        ...
        // Theme colors come from the live resources (Preview.cs BrushHex); the rendering
        // itself lives in Services/HtmlExport.cs.
        private string DocumentToHtml(FlowDocument doc, string title) =>
            HtmlExport.FromDocument(doc, title,
                BrushHex("PaneBrush", "#1c1c1c"),
                BrushHex("TextBrush", "#e0e0e0"),
                BrushHex("PrimaryBrush", "#B982E3"),
                BrushHex("CardBorderBrush", "#3a3a3a"));
